...
RSpec.describe 'measures/grouped/_table', type: :view do
  ...
  it 'renders analytics hooks for the tariff section and calculator', :aggregate_failures do
    expect(rendered_page).to have_css 'section[data-analytics-section="import_duties"][data-analytics-exposure-event="commodity_tariff_section_shown"]'
    expect(rendered_page).to have_css '#duty-calculator[data-analytics-exposure-event="commodity_duty_calculator_shown"]'
  end
