...
gem 'addressable'
gem 'faraday', '1.9.0' # TODO: Debug issue with newer versions of Faraday client under high loads
...
# gov UK
gem 'govspeak'
gem 'nokogiri', '~> 1.13.3' # https://github.com/sparklemotion/nokogiri/issues/2205
gem 'plek'
